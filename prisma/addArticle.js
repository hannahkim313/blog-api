...
addArticle(
  ...
  `
  <section class="textContainer-lg">
  <h2 class="mb-xs">Introduction</h2>
  <div class="textContainer-sm">
    <p>
      Working with APIs is a crucial skill in web development, one that quickly
      becomes second nature for frontend developers. In order for our
      ...
      experiences. Both my
      <a
        class="ctaSecondary ctaSecondaryBold"
        href="https://github.com/hannahkim313/shopping-cart"
        >Mock E-Commerce Store</a
      >
      and
      <a
        class="ctaSecondary ctaSecondaryBold"
        href="https://github.com/hannahkim313/memory-card"
        >Memory Card Game</a
      >
      showcase my ability to work with APIs in different contexts. For my most
      recent project, however, I wanted to challenge myself further by building
      a RESTful blog API from scratch.
    </p>
    <br />
    <p>
      In this article, I will go over how I developed a simple blog API using
      Node.js and Express. The goal of this project was to create a backend that
      allows for creating, reading, updating, and deleting (CRUD) of blog posts
      while also handling key API requirements like error handling and
      validation. Through this project, I gained valuable experience in backend
      development, which has deepened my understanding of how APIs function and
      how they can enhance my work as a frontend developer.
    </p>
  </div>
</section>
<section class="textContainer-lg">
  <h2 class="mb-xs">Project Setup and Tools</h2>
  <div class="textContainer-sm">
    <p>
      ...
      blog into their web applications. As a result, user role assignment during
      registration does not involve any checks. New users are assigned the role
      <code>user</code> by default. The only way to assign the
      <code>author</code> role is by hardcoding a new user into the database
      with that role. To simplify this process, a <code>seed.js</code> file was
      created, allowing you to assign yourself the <code>author</code> role
      using environment variables.
    </p>
    <br />
    <p>
      Keeping the previously mentioned design in mind, here is an outline of the
      key tools and packages used in this project:
    </p>
    <br />
    <ul style="display: flex; flex-direction: column; gap: var(--spacing-md)">
      <li>
        <code style="font-weight: bold">Node.js</code>: For creating routes and
        handling requests.
      </li>
      <li>
        <code style="font-weight: bold">PostgreSQL</code>: For database
        management.
      </li>
      <li>
        <code style="font-weight: bold">Prisma</code>: For simplifying database
        queries with an ORM.
      </li>
      <li>
        <code style="font-weight: bold">Passport.js</code> and
        <code style="font-weight: bold">jsonwebtoken</code>: For authenticating
        and authorizing users.
      </li>
      <li>
        <code style="font-weight: bold">bcryptjs</code>: For securely hashing
        and storing passwords.
      </li>
      <li>
        <code style="font-weight: bold">cors</code>: For controlling access to
        resources from different domains.
      </li>
      <li>
        <code style="font-weight: bold">express-validator</code>: For validating
        and sanitizing incoming requests.
      </li>
      <li>
        <code style="font-weight: bold">dotenv</code>: For managing environment
        variables securely.
      </li>
      <li>
        <code style="font-weight: bold">Postman</code>: For testing API
...
<section class="textContainer-lg">
  <h2 class="mb-xs">Defining the Models</h2>
  <div class="textContainer-sm">
    <p>
      The first step in creating a simple blog API was to define the necessary
      models for the database. Most blogs typically feature readers, blog posts,
      and often a commenting system. To capture these fundamental elements, I
      determined three models that would provide a solid foundation for the API:
...
model Comment {
  ...
  <section class="textContainer-sm">
    <h3 class="mb-xs">Key Components</h3>
    <p>
      ...
      each model in the database rather than relying on Prisma's default naming
      conventions. This explicit mapping ensures consistency and avoids
      potential conflicts with PostgreSQL's reserved keywords.
    </p>
  </section>
  <section class="textContainer-sm">
    <h3 class="mb-xs">Enum Usage</h3>
    <p>
      ...
      for authorizing users in specific requests, such as distinguishing between
      users who can create articles and those who cannot.
    </p>
  </section>
  <section class="textContainer-sm">
    <h3 class="mb-xs">Relationships</h3>
    <p>
...
<section class="textContainer-lg">
  <h2 class="mb-xs">Structuring the Application</h2>
  <div class="textContainer-sm">
    <p>
...
app.listen(PORT, () => console.log(Server running on port $${'PORT'}!));
  ...
  <section class="textContainer-sm">
    <h3 class="mb-xs">Application-Level Middleware</h3>
    <p>
  ...
  <section class="textContainer-sm">
    <h3 class="mb-xs">Route Definitions</h3>
    <p>
      ...
      to their respective routes. I will go into detail about how the routes are
      structured in the following section.
    </p>
  </section>
  <section class="textContainer-sm">
    <h3 class="mb-xs">Error Handling</h3>
    <p>
      ...
      requests. The
      <code>logError()</code> utility function logs errors to the console only
      if <code>NODE_ENV</code> is set to <code>development</code>, preventing
      sensitive error information from being exposed to users.
    </p>
  </section>
</section>
<section class="textContainer-lg">
  <h2 class="mb-xs">Setting Up Routes</h2>
  <div class="mb-xs">
    <p>
      ...
      <code>articlesRouter</code>, and <code>commentsRouter</code>. Each router
      handles the authentication, articles, and comments feature of the API,
      respectively, using controllers to process incoming requests and
      middlewares to promote security and validation. I will go through the
      structure of one of these routers, focusing on how routes, middleware, and
      controller functions are organized.
    </p>
  </div>
  <section class="textContainer-lg">
    <h3 class="mb-xs">Example: Authentication Routes</h3>
    <div class="textContainer-sm">
      <p>
        The <code>authRouter</code> manages routes related to user registration,
        login, logout, and profile management. The structure looks like this:
      </p>
      <br />
      <pre>
        <code>
...
module.exports = authRouter;
    ...
    <section class="textContainer-lg">
      <h4 class="mb-xs">Route Structure</h4>
      <div class="textContainer-sm">
        <p>
...
authRouter.post(
  ...
  authController.authLogin
    ...
    <section class="textContainer-lg">
      <h4 class="mb-xs">Route-Level Middleware</h4>
      <div class="textContainer-sm">
        <p>
...
authRouter.post(
  ...
  authController.authLogin
        ...
        <p>
          ...
          defined in
          <code>app.js</code>. This process, known as
...
<section class="textContainer-lg">
  ...
  <div class="textContainer-sm">
    <p>
      Controller functions handle the core logic of each route after the request
      passes through middleware. They perform operations such as processing
      requests, interacting with the database, and sending appropriate
      responses. In <code>authRouter</code>, these responsibilities are managed
      by <code>authController</code>, which contains functions for user-related
      operations like registration, login, logout, and profile management.
    </p>
  </div>
  <section class="textContainer-sm">
    <h3 class="mb-xs">Example: Authentication Controller</h3>
    <div class="textContainer-sm">
      <p>
...
module.exports = {
  ...
  <section class="textContainer-sm">
    <h3 class="mb-xs">
      Error Handling with <code>handleValidationErrors</code>
    </h3>
    <div class="textContainer-sm">
      <p>
        ...
        functions. When invoked, it checks for validation errors in the request
        and, if found, logs them to the console (when <code>NODE_ENV</code> is
        set to <code>development</code>). The function then sends a JSON
        response with the specified status code, preventing the request from
        continuing to the controller logic when invalid data is present. This
        ensures a consistent response structure for validation errors and helps
        maintain security by catching issues early in the request flow.
      </p>
      <br />
      <pre>
        <code>
...
module.exports = {
  ...
  <section class="textContainer-sm">
    <h3 class="mb-xs">Database Operations Using Prisma</h3>
    <div class="textContainer-sm">
      <p>
        ...
        structured way. Most functions within <code>authController</code> focus
        on checking data existence (e.g., retrieving a user profile by ID) or
        modifying data (e.g., updating profile information). This approach takes
        advantage of Prisma's methods, such as <code>findUnique</code>,
        <code>update</code>, <code>delete</code>, and <code>create</code>, to
        maintain code readability while simplifying database interactions.
      </p>
    </div>
  </section>
  <section class="textContainer-sm">
    <h3 class="mb-xs">Sending Responses with <code>sendResponse</code></h3>
    <div class="textContainer-sm">
      <p>
        ...
        <code>sendResponse</code>, the application maintains a consistent format
...
<section class="textContainer-lg">
  <h2 class="mb-xs">Conclusion</h2>
  <div class="textContainer-sm">
    <p>
      This blog API demonstrates a basic yet fully functional setup for managing
      blog posts, users, and comments. Through an organized approach of routes,
      middlewares, and controller functions, the API provides a scalable
      foundation for blog management. In addition, implementing key tools and
      packages for authentication, authorization, error handling, and validation
      add to the API's level of security and maintainability.
    </p>
    <br />
    <p>
      ...
      complex use cases. Its modular structure makes it possible to incorporate
      additional features, such as multi-author support, without compromising
    ...
    <br />
    <p>
      To explore the full source code of this project and learn how to implement
      the API into web applications, visit the project's
      <a
        class="ctaSecondary ctaSecondaryBold"
        href="https://github.com/hannahkim313/blog-api"
        >GitHub repository</a
      >.
    </p>
  </div>
